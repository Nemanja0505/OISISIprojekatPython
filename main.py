...
if __name__ == '__main__':
    ...
    while running:
        ...
        print(' ' * 30, 'NAPOMENA : neophodno je prvo izabrati direktorijum\n', ' ' * 29,
              'za pravilno izvrsavanje ostalih funkcionalnosti\n', ' ' * 20, '-' * 65)
        ...
        if unos == '1':
            ...
            if pathDirectory == '':
                ...
                print(' ' * 40, 'UPUTSVO KORISCENJA NAPREDNE PRETRAGE\n', ' ' * 30,
                      '*Moguce je koriscenje operatora [&&,||,!]\n', ' ' * 30,
                      '*Napredna pretraga podrzava slozenije upite\n', ' ' * 30,
                      '*Primer: (dictionary || list || set) && !tree\n')
